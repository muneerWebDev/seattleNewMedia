...
<main class="work-detail-page">
    ...
    <section class="layout-1 brief">
        <div class="container">
            ...
            <div class="group skewed" data-scroll>
    ...
    <section class="next-case text-center">
        <a href="javaScript:void(0)" class="btn btn-arrow h2"><span>Next case</span></a>
    </section>
